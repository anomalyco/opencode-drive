...
`packages/drive` is the generic published package. `apps/catalog` owns OpenCode-specific specimen IDs, taxonomies, captures, and review UI; the package must not import the app.
